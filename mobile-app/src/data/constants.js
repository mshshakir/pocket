...
/**
 * Keyword → icon/colour hints used when a category is created without the
 * user explicitly picking an appearance (CSV import, quick-add in the
 * category picker). Consumed by CategoryService.guessAppearance().
 */
export const CATEGORY_APPEARANCE_DEFAULTS = Object.freeze([
...
/** Palette used to derive a stable colour from a category/account name. */
export const NAME_COLOR_PALETTE = Object.freeze([
  '#0ea5e9','#22c55e','#a855f7','#f97316','#14b8a6','#ec4899','#ef4444','#0891b2','#8b5cf6','#f59e0b',
]);
