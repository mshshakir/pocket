...
/// A transaction's recurrence settings (stored on the TEMPLATE transaction;
/// generated instances carry `recurringSourceId` instead).
class RecurringSpec {
  final RecurrenceRule rule;
  final int interval;

  /// Last date (inclusive) an instance may be generated for; null = forever.
  final DateTime? until;

  const RecurringSpec({required this.rule, this.interval = 1, this.until});
}
