...
class Budget {
  ...
  /// Copy with selected fields replaced. [legacyCategoryId] uses a sentinel so
  /// it can be explicitly cleared (e.g. when its category is deleted).
  Budget copyWith({
    List<String>? categoryIds,
    Object? legacyCategoryId = _budgetUndefined,
    int? amount,
    String? currency,
    BudgetPeriod? period,
    bool? rollover,
      ...
      Budget(
        ...
        legacyCategoryId: legacyCategoryId == _budgetUndefined
            ? this.legacyCategoryId
            : legacyCategoryId as String?,
...
/// Sentinel marking "argument not supplied" in [Budget.copyWith].
const Object _budgetUndefined = Object();
