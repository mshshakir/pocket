...
class DashboardScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    for (final t in txs) {
      ...
      // Frozen snapshot preferred (audit B1) — live conversion only for
      // legacy rows without one.
      final inHome = LedgerMath.homeAmount(t, fx, home);
          ...
          children: [
            ...
            _StatGrid(cards: [
              _StatCard(
                  ...
                  sub:
                      '${ref.watch(activeAccountsProvider).length} accounts · $home'),
              _StatCard(
