...
class ReportsScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    for (final t in txs) {
      ...
      // Frozen tx→home snapshots preferred (audit B1); split slices scale
      // the snapshot proportionally so they stay drift-free too.
      final txHome = LedgerMath.homeAmount(t, fx, home);
