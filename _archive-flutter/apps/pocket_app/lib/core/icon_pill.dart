...
/// Icon names offered by the account picker (legacy account-type icons plus
/// a few extras).
const List<String> kAccountIcons = [
  'wallet', 'landmark', 'credit-card', 'banknote', 'piggy-bank',
  'trending-up', 'briefcase', 'home', 'phone', 'gift',
];
